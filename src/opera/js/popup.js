$(document).ready(function(){
    ...
    $( "#slider-range-min" ).slider({
      ...
      slide: function( event, ui ) {
        if (ui.value >= 70) {
          $('#note').hide();
            $("#cta").html("How about treating me a cup of joe to back my work and becoming a <a href='https://t4bzzz.com/crypto' target='_blank'>project sponsor</a>?");
        } else if (ui.value >= 30) {
          $('#note').hide();
            $("#cta").html("If you'd like to help, leave a star over <a href='https://github.com/T4bzzz/ZenBlock-YouTube-AdBlock' target='_blank'>GitHub</a> or share the extension with your colleagues.");
        } else {
          $('#note').show();
            $("#cta").html("Read <a href='https://github.com/T4bzzz/ZenBlock-YouTube-AdBlock?tab=readme-ov-file#faq' target='_blank'>FAQ</a>s for using other adblockers with zenblock.");
        }
